...
void GLSphereDirect::initShader(void)
{
	...
	case 2:
		...
		_projectionMatrixLocation = glGetUniformLocation(_program, "projectionMatrixBox2"); // Get the location of our projection matrix in the shader
		_viewMatrixLocation = glGetUniformLocation(_program, "viewMatrixBox2"); // Get the location of our view matrix in the shader
		_modelMatrixLocation = glGetUniformLocation(_program, "modelMatrixBox2"); // Get the location of our model matrix in the shader
		...
		_material._ambientColorPos = glGetUniformLocation(_program, "ambient_color2");
		_material._diffuseColorPos = glGetUniformLocation(_program, "diffuse_color2");
		_material._specularColorPos = glGetUniformLocation(_program, "specular_color2");
		_material._shininessIdx = glGetUniformLocation(_program, "shininess2");
